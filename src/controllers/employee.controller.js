...
const createEmployee = async (req, res) => {
  try {
    const companyId = req.user.company_id;
    const { first_name, last_name, email, password = 'defaultPassword123!', position, employment_status } = req.body;
    ...
    const user = await User.create({
      ...
      last_name,
      email,
      password_hash: hashedPassword,  // Password yang sudah dienkripsi
